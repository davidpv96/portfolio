...
const MainContent = ({ page }) => {
  ...
  return (
    <div className="container mx-auto p-14 flex flex-col items-center md:flex-row md:p-0 md:py-28 md:items-start">
      <h1 className="text-4xl font-bold mb-4  md:hidden">Sobre Mí</h1>
    <div className='md:sticky md:top-40 md:flex md:flex-col md:items-center md:w-1/3 md:bg-white md:p-14 md:mt-28 md:mr-10 md:rounded-2xl md:shadow-lg '>
  ...
  <div className="md:relative md:z-10 md:mt-12 ">
    {/* Nombre */}
    <h1 className="text-3xl font-semibold mb-2 text-center md:text-center">
      David Peñavasquez
    </h1>

    {/* Título */}
    <h2 className="text-xl text-stone-500 text-center md:text-center">
    ...
    <div className="flex justify-center space-x-4 md:mt-5 mt-5">
        {/* GitHub */}
        <Link to="url_tu_perfil_github" target="_blank" className=' p-3  bg-gray-100 rounded-lg'>
          <img
            src={GitHubIcon}
            alt="GitHub"
        ...
        {/* LinkedIn */}
        <Link to="url_tu_perfil_linkedin" target="_blank" className='p-3 bg-gray-100 rounded-lg'>
          <img
            src={LinkedinIcon}
            alt="LinkedIn"
            className="w-7 cursor-pointer"
      ...
      <div className="  w-full text-center mb-5 mt-5 bg-gray-100 p-6 rounded-xl">
        ...
        <div className="flex items-center mb-4  border-b border-neutral-200 pb-2">
          ...
          <p className="text-sm">davidpv96@hotmail.com</p>
          </div>
        </div>
  ...
  {/* Botón de Descarga */}
  <a
    href="ruta_de_tu_cv.pdf"  // Reemplaza con la ruta correcta de tu currículum
...
<div className='md:bg-white md:p-14  md:rounded-2xl md:shadow-lg'>
